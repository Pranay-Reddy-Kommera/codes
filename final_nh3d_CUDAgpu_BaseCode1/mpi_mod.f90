...
! implicit none
  ...
  public :: send_data, recv_data, gather_data_onto_master_rank,barrier,send,recv
...
!  subroutine send_data(bufsendS, bufsendE, bufsendN, bufsendW)
...
!  subroutine recv_data(bufrecvS, bufrecvE, bufrecvN, bufrecvW)
...
!    real(kind=real_kind), intent(in), dimension(:) :: bufsendE, bufsendW
    ...
    call MPI_ISEND(bufsendS_d, nSN, MPI_DOUBLE_PRECISION, rS, tagS, mpienv%comm, ireq, ierr)
    call MPI_ISEND(bufsendE_d, nEW, MPI_DOUBLE_PRECISION, rE, tagE, mpienv%comm, ireq, ierr)
    call MPI_ISEND(bufsendN_d, nSN, MPI_DOUBLE_PRECISION, rN, tagN, mpienv%comm, ireq, ierr)
    call MPI_ISEND(bufsendW_d, nEW, MPI_DOUBLE_PRECISION, rW, tagW, mpienv%comm, ireq, ierr)
  end subroutine send
...
!    real(kind=real_kind), intent(out), dimension(:) :: bufrecvE, bufrecvW
    ...
    call MPI_RECV(bufrecvS_d, nSN, MPI_DOUBLE_PRECISION, rS, tagN, mpienv%comm, istat, ierr)
    call MPI_RECV(bufrecvE_d, nEW, MPI_DOUBLE_PRECISION, rE, tagW, mpienv%comm, istat, ierr)
    call MPI_RECV(bufrecvN_d, nSN, MPI_DOUBLE_PRECISION, rN, tagS, mpienv%comm, istat, ierr)
    call MPI_RECV(bufrecvW_d, nEW, MPI_DOUBLE_PRECISION, rW, tagE, mpienv%comm, istat, ierr)
  end subroutine recv
