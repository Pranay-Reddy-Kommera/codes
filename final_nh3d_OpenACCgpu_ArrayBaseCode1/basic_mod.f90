...
! logical, parameter :: use_dim_split_scheme = .true.
 ...
 !! Config for inertia-gravity wave 
   ...
   integer, parameter :: ney = 32
   integer, parameter :: nez = 16 
   real(kind=real_kind), parameter :: dt = 0.20D0
...
!$acc declare create(name_of_the_test, endtime, xmin, xmax, ymin, ymax, zmin, zmax, delx, dely, delz, gllp, gllw, der, weakder)
!$acc declare create(bufsendS, bufrecvS, bufsendE, bufrecvE, bufsendN, bufrecvN, bufsendW, bufrecvW)
